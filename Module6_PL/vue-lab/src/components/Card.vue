<template>
  <div class="card">
    <div class="cardTitle">
      ...
      <img
        src="https://res.cloudinary.com/orderstaker/image/upload/v1565216096/others/menu.png"
        class="menuIcon"
        alt="menu"
      />
    </div>
    ...
    <div>
      <img
        src="https://res.cloudinary.com/orderstaker/image/upload/v1565216265/others/food.jpg"
        class="menuImage"
        alt="noodle"
      />
    </div>
    ...
    <div class="footer">
      <div>
        <img
          src="https://res.cloudinary.com/orderstaker/image/upload/v1565223868/others/heart.png"
          alt="save button"
          class="footerIcon"
        />
        <img
          src="https://res.cloudinary.com/orderstaker/image/upload/v1565223868/others/share.png"
          alt="share button"
          class="footerIcon"
        />
      </div>
      <img
        src="https://res.cloudinary.com/orderstaker/image/upload/v1565223868/others/expand.png"
        alt="expand button"
        class="footerIcon"
      />
    </div>
